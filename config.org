...
Better line wrapping when working with text:
...
Agent shell installation:
#+begin_src emacs-lisp
  (use-package shell-maker
    :load-path "packages/shell-maker")

  (use-package acp
    :load-path "packages/acp")

  (use-package agent-shell
    :load-path "packages/agent-shell"
    :config
...
#+begin_src emacs-lisp
  (defun my-md-faces ()
    ...
    (set-face-attribute 'markdown-table-face nil :family "IBM Plex Mono"))

  (use-package markdown-mode
    :load-path "packages/markdown-mode"
    :hook (markdown-mode . my-md-faces))
    :config
  ...
  (with-eval-after-load 'eglot
    (add-to-list 'eglot-server-programs
                 '((markdown-mode gfm-mode) .
                   ("rass" "--" "mpls" "--enable-wikilinks" "--enable-emoji" "--enable-footnotes" "--" "harper-ls" "--stdio"))))
...
#+begin_src emacs-lisp
  ...
  (use-package async
    :load-path "packages/async")

  (use-package elgrep
    :load-path "packages/elgrep")
  ...
  (use-package ht
    :load-path "packages/ht")

  (use-package f
    :load-path "packages/f.el")

  (use-package obsidian
    :load-path "packages/obsidian/"
    :config
...
#+begin_src emacs-lisp
  (with-eval-after-load 'eglot
    (add-to-list 'eglot-server-programs
                 '((python-mode) .
                   ("rass" "--" "basedpyright_langserver" "--" "ruff" "--stdio"))))
